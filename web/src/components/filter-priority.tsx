    ...
    <FilterContainer>
      ...
      {open && (
        <FilterList>
          ...
          <FilterItem onClick={() => handlePriority(FilterPriorityType.MINOR_PRICE)}>
            Preço: Maior - Menor
          </FilterItem>
          <FilterItem onClick={() => handlePriority(FilterPriorityType.BIGGEST_PRICE)}>
            Preço: Menor - Maior
          </FilterItem>
          <FilterItem onClick={() => handlePriority(FilterPriorityType.POPULARITY)}>
            Mais vendidos
          </FilterItem>
        </FilterList>
      )}
